...
async function loadApplication(cell_id) {
  ...
  const packages = ['https://cdn.holoviz.org/panel/0.14.2/dist/wheels/bokeh-2.4.3-py3-none-any.whl', 'https://cdn.holoviz.org/panel/0.14.2/dist/wheels/panel-0.14.2-py3-none-any.whl', 'pandas', 'pyodide-http', 'holoviews>=1.15.1'];
